...
public class ItemInit {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(Fnaf_Collectibles.MODID);

    public static final DeferredItem<Item> INDEX = ITEMS.register("index", IndexItem::new);

    public static final DeferredItem<Item> FNAFCOLLECTIBLEPACK = ITEMS.register("fnafcommonpack", () -> new CollectiblePackItem("common", new Item.Properties().rarity(Rarity.COMMON).stacksTo(1)));

    public static final DeferredItem<Item> CARDPULL = ITEMS.register("cardpull", () -> new CardPull(new Item.Properties()));

    public static class CardSet {
        public final DeferredItem<Item> common, uncommon, rare, epic, legendary;
    ...
    public static DeferredItem<Item> _card(String name, String lvl){
        if(lvl == "common") {
    ...
    public static Item[] cardsOf(Function<CardSet, DeferredItem<Item>> getter) {
    ...
    public static final DeferredRegister<DataComponentType<?>> COMPONENTS =
            DeferredRegister.create(Registries.DATA_COMPONENT_TYPE, Fnaf_Collectibles.MODID);

    public static final Supplier<DataComponentType<CardData>> CARD_DATA_COMPONENT = COMPONENTS.register("card_data",
            () -> DataComponentType.<CardData>builder()
                    .persistent(CardData.CODEC)
                    .networkSynchronized(CardData.STREAM_CODEC)
                    .build()
    );

    public static final Supplier<DataComponentType<IndexData>> INDEX_DATA_COMPONENT = COMPONENTS.register("index_data",
            () -> DataComponentType.<IndexData>builder()
                    .persistent(IndexData.CODEC)
                    .networkSynchronized(IndexData.STREAM_CODEC)
                    .build()
    );
}
